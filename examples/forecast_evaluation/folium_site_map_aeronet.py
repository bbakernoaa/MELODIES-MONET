...
# path to plots
path = (
    "/wrk/csd4/rahmadov/RAP-Chem/MELODIES-MONET-analysis/run_sites/plots_out/"
    + todays_date
    + "/"
)
...
for i in range(len(site_name)):
    ...
    image.save(
        fp=path + plot_name + "_resize.png"
    )  # save back to the original plot directory
    ...
    marker = folium.CircleMarker(
        location=[site_lat[-1], site_lon[-1]],
        popup=popup,
        radius=7,
        color="blue",
        fill_color="blue",
