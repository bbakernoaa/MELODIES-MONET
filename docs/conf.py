...
project = "MELODIES-MONET"
copyright = "2022, NSF NCAR, CIRES"
author = "Rebecca Schwantes (NOAA), Barry Baker (NOAA), Louisa Emmons (NCAR), Rebecca Buchholz (NCAR)"
...
autodoc_mock_imports = ["ESMF", "esmpy", "xesmf"]
...
latex_documents = [
    (
        ...
        "Rebecca Schwantes (NOAA) \\and Barry Baker (NOAA) \\and Louisa Emmons (NCAR) \\and Rebecca Buchholz (NCAR)",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "melodies-monet", "MELODIES-MONET Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "melodies-monet",
        "Analysis tool for atmopsheric chemistry modeling.",
        "Miscellaneous",
    ),
]
...
linkcheck_ignore = [
    ...
    "https://monetio.readthedocs.io/en/stable/cli.html",
    ...
    "https://monet-arl.readthedocs.io/en/stable/installing.html",
    ...
    "https://www.camx.com/",
    "https://earthscience.arc.nasa.gov/mms",
]
