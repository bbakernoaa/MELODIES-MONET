...
.. note::
   ...
   MELODIES MONET leverages :mod:`monetio` to directly load many of these datasets. Users simply need to specify the source (e.g., 'airnow') in the YAML configuration.
